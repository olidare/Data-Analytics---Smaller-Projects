...
# Anchor Member Execution: The CTE starts its execution with the anchor member which is a non recursive query. It initializes the initial rows of the CTE that serves as the starting point of the recursion.
